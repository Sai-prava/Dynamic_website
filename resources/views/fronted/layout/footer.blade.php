            ...
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <a class="btn btn-link" href="{{route('fronted.about')}}">About Us</a>
                        <a class="btn btn-link" href="{{route('fronted.contact')}}">Contact Us</a>
                        <a class="btn btn-link" href="{{route('fronted.service')}}">Service</a>
                        <a class="btn btn-link" href="{{route('fronted.menu')}}">Menu</a>
                        <a class="btn btn-link" href="{{route('fronted.book')}}">Booking</a>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <h4 class="section-title ff-secondary text-start text-primary fw-normal mb-4">Contact</h4>
                        <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Acharyavihar,Bhubanesware</p>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
							...
							Designed By <a class="border-bottom" href="https://htmlcodex.com">Saiprava</a>
                        </div>
