...
<head>
    ...
    <link href="{{asset('backend/lib/animate/animate.min.css')}}" rel="stylesheet">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        ...
                        <a href="{{route('fronted.about')}}" class="nav-item nav-link">About</a>
                        <a href="{{route('fronted.service')}}" class="nav-item nav-link">Service</a>
                        <a href="{{route('fronted.menu')}}" class="nav-item nav-link">Menu</a>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
                            <div class="dropdown-menu m-0">
                                <a href="{{route('booking.email')}}" class="dropdown-item">Booking</a>
                                <a href="{{route('fronted.team')}}" class="dropdown-item">Our Team</a>
                                <a href="{{route('fronted.testiomnial')}}" class="dropdown-item">Testimonial</a>
                            </div>
                        </div>
                        <a href="{{route('fronted.contact')}}" class="nav-item nav-link">Contact</a>
                    </div>
                    <a href="{{route('auth.login')}}" class="btn btn-primary py-2 px-4">Dashboard</a>
                </div>
            </nav>
                ...
                <div class="container my-5 py-5">
                    <div class="row align-items-center g-5">
                        ...
                        <div class="col-lg-6 text-center text-lg-end overflow-hidden">
                            <img class="img-fluid" src="{{asset('backend/img/hero.png')}}" alt="">
                        </div>
                    </div>
                </div>
            </div> --}}
