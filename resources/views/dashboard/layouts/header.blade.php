                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">  
                      <a href="{{route('auth.logout')}}" class="btn btn-default btn-flat">log out</a>
                    </div>
                  </li>
                </ul>
              </li>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="{{route('backend.herosection')}}">
            ...
            {{-- <li class="treeview">
              <a href="{{route('backend.viewbooking')}}">
            ...
            <li class="treeview">
              <a href="{{route('backend.viewcontact')}}">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{route('backend.menu')}}"><i class="fa fa-circle-o"></i> Breakfast</a></li>
                <li><a href="{{route('backend.lunch')}}"><i class="fa fa-circle-o"></i> Lunch</a></li>
                <li><a href="{{route('backend.dinner')}}"><i class="fa fa-circle-o"></i> Dinner</a></li>             
              </ul> 
            </li>                    
